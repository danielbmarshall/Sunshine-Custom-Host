...
class InstallationTracker:
    ...
    def __init__(self, base_path: str):
        ...
        self.default_paths = {
            ...
            "advanced_run": {
                "default_install_dir": os.path.join(SUNSHINE_TOOLS_DIR, "AdvancedRun"),
                "executables": ["AdvancedRun.exe"]
            },
            "auto_hide_mouse_cursor": {
                "default_install_dir": os.path.join(SUNSHINE_TOOLS_DIR, "AutoHideMouseCursor"),
                "executables": ["AutoHideMouseCursor.exe"]
            }
        }
