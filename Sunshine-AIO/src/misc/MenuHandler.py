    ...
    def __init__(self, base_path: str) -> None:
        ...
        self._map = [
            ...
            },
            {
                ...
                "8": lambda: self._dm.download_advanced_run(install=False, selective=True),
                "9": lambda: self._dm.download_auto_hide_mouse_cursor(install=False, selective=True),
                "10": self._previous_page,
                "0": sys.exit
            },
            {
